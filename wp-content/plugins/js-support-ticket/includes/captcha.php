...
class JSSTcaptcha {
    ...
    function getCaptchaForForm() {
        ...
        $add_string .= '</label>';
        $add_string .= '<input type="text" name="' . $_SESSION['jssupportticket_spamcheckid'] . '" id="' . $_SESSION['jssupportticket_spamcheckid'] . '" size="3" class="inputbox js-ticket-recaptcha ' . $rand . '" value="" data-validation="required" />';
        $add_string .= '</div>';
