            ...
            <div class="js-filter-form-list">
                ...
                foreach (jssupportticket::$_data[0] AS $priority) {
                    ...
                    <div class="js-filter-form-data">
                        ...
                        <div class="js-col-md-1 js-col-xs-12 third js-textaligncenter">
                            <span class="js-filter-form-data-xs">
                                <?php echo __('Default', 'js-support-ticket'); echo " : ";  ?>
                            </span>
                            <?php
                                $url  = "?page=priority&task=makedefault&action=jstask&priorityid=".$priority->id;
                                if($pagenum > 1){
                                    $url .= '&pagenum=' . $pagenum;
                                }
                            ?>
                            <a href="<?php echo wp_nonce_url($url, 'make-default');?>" ><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/<?php echo $isdefault; ?>" /></a>
                        </div>
                        <div class="js-col-md-1 js-col-xs-12 fourth js-textaligncenter">
                            ...
                            ?></span>
                               <?php if ($number != 0 || $pagenum > 1) { ?>
                                    ...
                                    ?>
                                    <a href="<?php echo wp_nonce_url($url, 'ordering');?>" ><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/uparrow.png" /></a>
                                <?php
                               }
                               ...
                               if ($number < $count) {
                                   ...
                                   <?php
                                    ...
                                    ?>
                                    <a href="<?php echo wp_nonce_url($url, 'ordering');?>" ><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/downarrow.png" /></a>
                                ...
                                <?php } elseif ($islastordershow) { ?>
                                    ...
                                    ?>
                                    <a href="<?php echo wp_nonce_url($url, 'ordering');?>" ><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/downarrow.png" /></a> <!-- last record on the page -->
                <?php } ?>
                        </div>
                    ...
                    ?></span> <div class="js-ticket-admin-prirrity-color" style="background:<?php echo $priority->prioritycolour; ?>;color:#ffffff;"> <?php echo $priority->prioritycolour; ?></div></div>
                        <div class="js-col-md-3 js-col-xs-12 sixth js-filter-form-action-hl-xs">
                            ...
                            <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=priority&task=deletepriority&action=jstask&priorityid='. $priority->id ,'delete-priority'); ?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" /></a>
                        </div>
                    </div>
                <?php
                $number++;
