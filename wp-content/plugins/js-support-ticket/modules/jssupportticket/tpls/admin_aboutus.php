<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('About Us','js-support-ticket'); ?></span>
        </span>
        ...
        <div class="js-admin-joomsky-wrapper">
            ...
            <div class="js-col-md-8">
                ...
                <span class="js-joomsky-link">
                    <a href="https://www.joomsky.com" target="_blank"><?php echo __('Goto Web', 'js-support-ticket'); ?></a>
                </span>
            </div>
            <div class="js-col-md-4">

                <img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/aboutus_page/product-images.png" />
                </a>
            </div>
        </div>
        ...
        <div class="js-col-md-4">
            <a href="https://www.joomsky.com/index.php/products/js-autoz-1/js-autoz-pro" target="_blank">
                <img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/aboutus_page/autoz.jpg" />
            </a>
        </div>
        <div class="js-col-md-4">
