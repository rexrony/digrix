...
<script type="text/javascript">
    ...
    <span class="js-adminhead-title">
        <a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=fieldordering&fieldfor='.jssupportticket::$_data['fieldfor']);?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext">
        <?php
