...
class JSSTdepartmentModel {
    ...
    function storeDepartment($data) {
        ...
        if(isset($data['ispublic'])){
            $query_array['ispublic'] = $data['ispublic'];
        }
        if(isset($data['canappendsignature'])){
            $query_array['canappendsignature'] = $data['canappendsignature'];
        }
    ...
    function removeDepartment($id) {
        ...
        if ($this->canRemoveDepartment($id)) {
            ...
            JSSTmessage::setMessage(__('Department in use cannot be deleted', 'js-support-ticket'), 'error');
        }
        return;
    }
