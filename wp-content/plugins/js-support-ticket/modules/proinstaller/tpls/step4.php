<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=proinstaller&jstlay=step3');?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __("Tickets Updater", 'js-support-ticket') ?></span></span>
        <div id="jsst-main-wrapper" >
            ...
            <div id="jsst-finish-message">
                ...
                <?php echo __('JS Ticket Pro Installed Successfully','js-support-ticket'); ?>
            </div>
            <div id="jsst-finish-message-1"><?php echo __('Thanks For Installing JS Ticket Pro','js-support-ticket'); ?></div>
            ...
            <div class="js-row" id="jsst-finish-button">        
                <a class="nextbutton" href="<?php echo admin_url("admin.php?page=jssupportticket"); ?>"><?php echo __('Start using', 'js-support-ticket'); ?></a>
            </div>    
        </div>
    </div>
</div>