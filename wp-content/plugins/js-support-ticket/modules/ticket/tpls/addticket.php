                        ...
                        switch ($field->field) {
                            case 'email':
                                ...
                                <div class="js-ticket-from-field-wrp">
                                    <div class="js-ticket-from-field-title"><?php echo __($field->fieldtitle, 'js-support-ticket'); ?>&nbsp;<font color="red">*</font></div>
                                ...
                                <div class="js-ticket-from-field-wrp">
                                    ...
                                    <div class="js-ticket-from-field">
                                        <?php 
                                            ...
                                            echo JSSTformfield::text('phoneext', $phoneext, array('class' => 'inputbox js-ticket-form-field-input','data-validation'));
                                        ?>
                                    </div>
                                </div>
                                <?php
                            ...
                            case 'department':
                                ...
                                ?>
                                <div class="js-ticket-from-field-wrp">
                                    <div class="js-ticket-from-field-title"><?php echo __($field->fieldtitle, 'js-support-ticket'); ?><?php if($field->required == 1) echo '&nbsp;<font color="red">*</font>'; ?></div>
                            ...
                            case 'attachments':
                                ...
                                <div class="js-ticket-reply-attachments"><!-- Attachments -->
                                    <div class="js-attachment-field-title"><?php echo __($field->fieldtitle, 'js-support-ticket'); ?><?php if($field->required == 1) echo '&nbsp;<font color="red">*</font>'; ?></div>
                                            ...
                                            foreach (jssupportticket::$_data[5] AS $attachment) {
                                                echo '
                                                    <div class="js-ticket-attached-files-wrp">
                                                        ...
                                                        <a class="js-ticket-delete-attachment" href="'.jssupportticket::makeUrl(array('jstmod'=>'downloadattachment', 'task'=>'deleteattachment', 'action'=>'jstask', 'id'=>$attachment->id, 'downloadid'=>jssupportticket::$_data[0]->id, 'jsstpageid'=>get_the_ID())) . '">' . __('Remove','js-support-ticket') . '</a>
                                                    </div>';
                                            }
                                    } ?> -->
                                </div>
