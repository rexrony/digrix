...
<div id="jsstadmin-wrapper">
    ...
    <a class="js-add-link button" href="?page=ticket&jstlay=addticket"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add Ticket', 'js-support-ticket'); ?></a>
        ...
        <form class="js-filter-form" name="jssupportticketform" id="jssupportticketform" method="post" action="<?php echo admin_url("admin.php?page=ticket&jstlay=tickets"); ?>">
            ...
            <?php echo JSSTformfield::select('priorityid', JSSTincluder::getJSModel('priority')->getPriorityForCombobox(), jssupportticket::$_data['filter']['priorityid'], __('Select','js-support-ticket').' '.__($field_array['priority'],'js-support-ticket')); ?>
                ...
                <?php echo $status; ?>
                    ...
                    <div class="js-col-xs-12 js-col-md-12 js-ticket-bottom-data-part">
                        ...
                        <div class="js-ticket-datapart-buttons-action">	
                            <a class="js-ticket-bottom-data-part-action-button button"  onclick="return confirm('<?php echo __('Are you sure to enforce delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=ticket&task=enforcedeleteticket&action=jstask&ticketid='. $ticket->id,'enforce-delete-ticket');?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/close.png" /><?php echo __('Enforce delete', 'js-support-ticket'); ?></a>
                            <a class="js-ticket-bottom-data-part-action-button button"  onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=ticket&task=deleteticket&action=jstask&ticketid='.$ticket->id,'delete-ticket' );?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" /><?php echo __('Delete', 'js-support-ticket'); ?></a>
