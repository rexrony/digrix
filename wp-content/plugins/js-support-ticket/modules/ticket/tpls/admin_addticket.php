            ...
            foreach (jssupportticket::$_data['fieldordering'] AS $field):
                switch ($field->field) {
                    case 'users':
                        ...
                        elseif(isset(jssupportticket::$_data[0]->user_login))
                        ...
                        <div class="js-form-wrapper">
                            ...
                            <div class="js-form-field">
                                ...
                                elseif (isset(jssupportticket::$_data[0]->departmentid))
                                    ...
                                    $departmentid = '';
                                echo JSSTformfield::select('departmentid', JSSTincluder::getJSModel('department')->getDepartmentForCombobox(), $departmentid, __('Select Department', 'js-support-ticket'), array('class' => 'inputbox', 'data-validation' => ($field->required) ? 'required' : ''));
                                ?>
                            </div>
                        </div>
                        <?php
                    ...
                    case 'attachments':
                        ...
                        <?php /* <span class="tk_attachments_configform">
                            <small><?php echo __('Maximum File Size', 'js-support-ticket');
                echo ' (' . jssupportticket::$_config['file_maximum_size'];
                ?>KB)<br>
                        <?php echo __('File Extension Type', 'js-support-ticket');
