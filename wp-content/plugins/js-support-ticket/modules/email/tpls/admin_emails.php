...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('System Emails', 'js-support-ticket'); ?></span>
        ...
        <span style="display:inline-block;width:100%;" class="js-admin-infotitle"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/infoicon.png" /><?php echo __('System email used for sending email', 'js-support-ticket'); ?></span>
            ...
            <div class="js-filter-form-list">
                ...
                foreach (jssupportticket::$_data[0] AS $email) {
                    ...
                    <div class="js-filter-form-data">
                        <div class="js-col-xs-12 js-col-md-6 first"><span class="js-filter-form-data-xs"><?php
                                echo __('Email Address', 'js-support-ticket');
                                echo " : ";
                                ?></span><a href="?page=email&jstlay=addemail&jssupportticketid=<?php echo $email->id; ?>"><?php echo $email->email; ?></a></div>
                        <div class="js-col-xs-12 js-col-md-2 js-textaligncenter  second"><span class="js-filter-form-data-xs"><?php
                                echo __('Autoresponse', 'js-support-ticket');
                                echo " : ";
                                ?></span><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/<?php echo $autoresponse; ?>" /></div>
                        ...
                        <div class="js-col-xs-12 js-col-md-2 fourth"><span class="js-filter-form-data-xs"><?php
                        echo __('Created', 'js-support-ticket');
                        echo " : ";
                        ?></span><?php echo date_i18n(jssupportticket::$_config['date_format'], strtotime($email->created)); ?></div>
                        <div class="js-col-xs-12 js-col-md-2 fifth js-filter-form-action-hl-xs">
                            ...
                            <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=email&task=deleteemail&action=jstask&emailid='. $email->id,'delete-email');?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" /></a>
                        </div>
                    </div>
            <?php }
            ?>
